...
export default function Hero() {
  return (
    <div className="px-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 dark:bg-white bg-black dark:bg-dot-black/[0.4] bg-dot-white/[0.4]" id="#Home">
      <section
        className="relative w-full grid place-items-center grid-cols-2 gap-4 items-center pt-8 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl"
      >
        <div className="relative order-last text-left md:order-first z-10 max-w-2xl  animate-fade-in">
          ...
          <div className="mt-5 sm:mt-8 animate-fade-in-up delay-200">
            ...
            <Link
              ...
              prefetch={false}
            >
              Know More <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" className="ml-2"><path d="M7 7h8.586L5.293 17.293l1.414 1.414L17 8.414V17h2V5H7v2z"/></svg></span>
            </Link>
          </div>
        </div>
