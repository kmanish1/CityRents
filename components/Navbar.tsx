  ...
  return (
    <div className="flex bg-deepBlue relative py-3 w- [1080px] mx-auto items-center justify-evenly overflow-x-hidden">
        ...
        <div className="flex space-x-6">
            <button className=" border-blue-600 border text-sm px-3 py-1 rounded font-mullish font-bold">Log in</button>
            ...
            <button className="px-3 py-1 rounded font-mullish text-sm text-blue-400 hover:text-blue-500 font-bold">Sign Up</button>
        </div>
        <div className="hidden lg:block"><button className="text-center rounded bg-blue-500 text-white px-4 py-2 ">Submit Property</button></div>
    </div>
  );
}
